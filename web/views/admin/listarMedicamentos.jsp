                    ...
                    <div class="span9">
                        ...
                        <form action="../../GestionarMedicamentoServlet" method="post">
                            <fieldset> 
                                ...
                                <td>
                                    <a rel="tooltip" title="Editar" href="<%=request.getServletContext().getContextPath()%>/views/admin/editarMedicamento.jsp?nombre=<%=((Medicamento) lista.get(i)).getNombre()%>&tipo=<%=((Medicamento)lista.get(i)).getTipo()%>"><i class="icon-edit"></i></a>
                                    <a rel="tooltip" title="Eliminar" href="<%=request.getServletContext().getContextPath()%>/GestionarMedicamentoServlet?nombre=<%=((Medicamento) lista.get(i)).getNombre()%>&tipo=<%=((Medicamento) lista.get(i)).getTipo()%>&accion=eliminar"><i id="iconoEliminar" class="icon-trash"></i></a>
                                    <a rel="tooltip" title="Ver descripci&oacute;n" href="<%=request.getServletContext().getContextPath()%>/views/admin/descMedicamento.jsp?nombre=<%=((Medicamento) lista.get(i)).getNombre()%>&tipo=<%=((Medicamento)lista.get(i)).getTipo()%>"><i class="icon-list-alt"></i></a>
                                </td>                                
                                </tr>
                                <%}%>
                                </tbody>
